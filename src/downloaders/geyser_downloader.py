...
class GeyserDownloader(GeyserMcDownloader):
    API_BASE_URL_V2_LATEST: str = "https://download.geysermc.org/v2/projects/geyser/versions/latest/builds/latest"
    PROJECT: str = "geyser"
    DOWNLOAD_SUBPATH: str = "spigot"
    DEFAULT_DOWNLOAD_DIR: str = "geyser_downloads"
    FILENAME_PATTERN: str = "Geyser-Spigot-*-SNAPSHOT.jar"  # Specific pattern for Geyser
