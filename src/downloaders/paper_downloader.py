...
class StableVersionStrategy(VersionFetchStrategy):
    ...
    @staticmethod
    def _get_build_data_static(version: str, build_number: int) -> Optional[Dict[str, Any]]:
...
class PaperDownloader:
    def __init__(self, download_directory: str = DEFAULT_DOWNLOAD_DIR, version_strategy: VersionFetchStrategy = StableVersionStrategy()) -> None:
    ...
    def download(self) -> Optional[str]:
        ...
        if version and build is not None:
